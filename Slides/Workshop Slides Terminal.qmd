...
For installing **R** and RStudio: [https://cloud.r-project.org](https://cloud.r-project.org) and [https://posit.co/download/rstudio-desktop](https://posit.co/download/rstudio-desktop)

Install Positron here (optional): [https://positron.posit.co/download.html](https://positron.posit.co/download.html)

Install Git here: [https://git-scm.com/install](https://git-scm.com/install) and if on Windows, that will also install Git Bash.
...
![](figs/intro_figs/positron_first.png){width=90%}

## Positron Typical Workflow

![](figs/intro_figs/positron.png){width=90%}
...
We will also need to make sure it connects to **R** (and Python if you have that installed). Click on "Start Session" in the top right. You should be able to click on the **R** version you have installed on your computer. If you have Python installed, you an easily swtich back and forth between **R** and Python. 
...
```{r session_info2, echo = FALSE, eval = TRUE}
sessionInfo()
```
